...
(function() {
  var AboutPage, arcgis_server, basemap, completedModelsMode, connectButtons, countyOutline, data2011, displayLayer, downloadSHP, flayer, getRasterData, googAnim, historicalMode, imgLayer, initLayers, initLegend, initSlider, init_map, inputPane, inputp, kmlLayer, legend, link, linux_server, list, map, modelingMode, modelingWidget, newsLayer, newsMode, predictionLayer, predictionLayer2, raster_data, rateLayer, showSlider, state_list, testImage, timeSlider, _i, _len, _ref;

  _ref = ["esri.map", "esri.layers.FeatureLayer", "modules.RasterLayer", "esri.dijit.TimeSlider", "esri.dijit.Legend", "dojo.dom-construct", "dijit.form.Select", "esri.layers.MapImageLayer", "dijit.Dialog"];
  ...
  downloadSHP = function(name) {
    var cont, dialog;
    cont = dojo.create("div", {
      id: "dl"
    });
    dojo.create("span", {
      id: "dl_label",
  ...
  inputPane = (function() {
    ...
    sendValues = function() {
      var node, outData, _j, _len1, _ref1;
      console.log(state);
      if (!state) {
        return;
      }
